# mqtt_listener_kt.py / mqtt_listener_skt.py / mqtt_listener_lgu.py
# carrier 이름만 각각 KT, SKT, LGU+ 로 바꿔서 저장하세요
...
MQTT_TOPIC = "dnscheck/kt"  # ✅ KT/SKT/LGU+ 에 따라 "dnscheck/skt", "dnscheck/lgu" 로 변경
CARRIER = "KT"  # ✅ 해당 파일에 맞게 "SKT" 또는 "LGU+"로 변경
